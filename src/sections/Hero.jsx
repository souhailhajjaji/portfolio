      ...
      <div className="relative z-10 max-w-6xl w-full px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="flex-1 text-center md:text-left">
            ...
            <h1 className="scroll-m-20 text-3xl sm:text-4xl md:text-6xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-cyan-500">
              Hi, I'm <span>Souhail Hajjaji</span>
            </h1>
            <h2 className="text-lg sm:text-xl md:text-2xl text-muted-foreground font-light mt-4">
              Engineering the Future of Software
            </h2>
            <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto md:mx-0 mt-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start pt-6">
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="px-6 sm:px-8 border-blue-500 text-blue-500 hover:bg-blue-500/10 mt-4 md:mt-0 w-full sm:w-auto"
          ...
          <div className="flex-1 flex justify-center">
            <div className="relative">
              <img 
                src={profilePic} 
                alt="Souhail Hajjaji" 
                className="w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 rounded-full object-cover border-4 border-blue-500/30 shadow-xl"
              />
